...
def show_playlist(playlist_id):
    ...
    songs = Song.query.join(PlaylistSong, PlaylistSong.song_id == Song.id).join(Playlist, playlist.id == PlaylistSong.playlist_id).all()
...
def show_song(song_id):
    ...
    playlists = Playlist.query.join(PlaylistSong, PlaylistSong.playlist_id == Playlist.id).join(Song, PlaylistSong.song_id == song.id).all()
...
def add_song_to_playlist(playlist_id):
    ...
    curr_on_playlist =  Song.query.join(PlaylistSong, PlaylistSong.song_id == Song.id).filter(PlaylistSong.playlist_id == playlist_id).all()
