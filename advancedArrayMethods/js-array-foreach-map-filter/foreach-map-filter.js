...
function onlyEvenValues(arr){
    let newArr = [];
    arr.forEach((value) => {
        value % 2 === 0 ? newArr.push(value) : false;
    })
    return newArr;
}
...
function vowelCount(str){
   ...
   letters.forEach(letter => {
       if ('aeiou'.includes(letter.toLowerCase())) {
           vowels[letter.toLowerCase()] ? vowels[letter.toLowerCase()]++ : vowels[letter.toLowerCase()] = 1;
       }
   })
   return vowels;
}
